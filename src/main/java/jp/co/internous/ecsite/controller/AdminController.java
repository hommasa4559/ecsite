...
public class AdminController {
	...
	//springbootを使って、springboot内の「モデル＝m」を使うとjava→HTMLに値(モデルがゆうパックの役割をする)を送る
	//m.addAttribute("送るものに付けるラベル" , 送りたいもの（＝fのgetter(メソッド));
	//箱をまとめて送る=return "HTMLのページ"
